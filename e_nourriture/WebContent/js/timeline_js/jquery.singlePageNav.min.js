/**
 * Single Page Nav Plugin Copyright (c) 2014 Chris Wojcik
 * <hello@chriswojcik.net> Dual licensed under MIT and GPL.
 * 
 * @author Chris Wojcik
 * @version 1.2.0
 */
...
(function(e, t, n, r) {
	...
	var i = {
		init : function(n, r) {
			...
			this.$links.on("click.singlePageNav", e.proxy(this.handleClick,
					this));
